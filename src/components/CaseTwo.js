...
const CONTENT = {
    ...
    tags: "AI · UI",
    h4: `Desenho da interface
    para o Festival do Amendoim`,
    ...
    texto: [<p>Trabalhei o fluxo do hotsite, desde os requisitos funcionais até as regras na mecânica da promoção.
      Criei o conceito visual e atuei no design de interfaces.
        ...
        bg: '#D80E2A',
    texto: [
    <img className='img_part mms_001' src={img_001}/>]
    },
    {
    bg: '#FFDE00',
texto: [
<img className='img_part mms_002' src={img_002}/>]
},
{
bg: '#000004',
texto: [
<img className='img_part mms_003' src={img_003}/>]
},
{
bg: '#181819',
texto: [<br/>,<br/>,
<img className='img_part mms_004' src={img_004}/>]
},
    ]
};
const PROP = {
...
export default withRouter(Casetwo);
